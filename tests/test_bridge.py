...
class TestPrefixRouting:
    ...
    async def test_codex_prefix_routes_to_codex(self):
        ...
        bridge._call_codex.assert_called_once_with("write tests", attachments=None)
...
class TestFollowup:
    ...
    async def test_followup_delegates_to_handle(self):
        ...
        bridge.handle.assert_called_once_with("C1", "ts1", "follow up question", attachments=None)
